...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var fbemitter_1 = __webpack_require__(616);
	var Card = (function () {
	...
	var Cash = (function () {
	    ...
	    Cash.prototype.process = function (amount) {
	        ...
	        if (this.amount > amount) this._change = this.amount - amount;
	        this.amount = 0;
	        return true;
	    };
	    ...
	    Object.defineProperty(Cash.prototype, "change", {
	        get: function () { console.log('get change', this._change); return this._change; },
	        enumerable: true,
	        configurable: true
	    });
	    return Cash;
